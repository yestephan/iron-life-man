...
--
-- Execution order:
--   1. 001_schema.sql - Creates tables, indexes, and functions
--   2. 002_triggers.sql - Creates triggers for updated_at timestamps
--   3. 003_policies.sql - Creates RLS policies (this file)
--
